...
def reasons_to_invest():
    link1 = "https://drive.google.com/file/d/1Ya_bWKt8ACv4qv2mOMrvJTbzOJt2uVHX/view?usp=drivesdk"
...
text1=Text(frame3, height=1, width=22, bg='#DCDCDC',fg='green', font=('',26), bd=-2)
...
submit_button=Button(frame3, text = 'SUBMIT', font=('',18), fg='black', bg='white', borderwidth=5, command=suggest)
...
reasons_to_invest_button = Button(frame3, text = 'Why Should I Invest?', font=('',15), fg='black', bg='#FFFFFF', borderwidth=5, command=reasons_to_invest)
...
text1=Text(frame3, height=1, width=30, bg='#DCDCDC',fg='black', font=('',26), bd=-2)
text1.insert(5.0, "OR")
text1.config(state='disabled')
...
estimate_button=Button(frame3, text = 'ESTIMATE PRICE', font=('',18), fg='green', bg='white', borderwidth=5, command=suggest2)
