...
def load_and_generate_results():
    Df = yf.download('GLD', '2007-01-01', '2024-03-15', auto_adjust=True)
    ...
    b1=Button(frame3, text = 'Original Values', font=('',18), fg='black', bg='white', borderwidth=5, command=original_values)
    b1.place(x=80,y=400)
    b2=Button(frame3, text = 'Predicted Values', font=('',18), fg='black', bg='white', borderwidth=5, command=predicted_values)
    b2.place(x=310,y=400)
    b3=Button(frame3, text = 'Cumulative Returns', font=('',18), fg='black', bg='white', borderwidth=5, command=cumulative_results)
    b3.place(x=550,y=400)
    show_result_button=Button(frame3, text = 'Our Recommendation', font=('',18), fg='green', bg='white', borderwidth=5, command=show_result_function)
...
text1=Text(frame3, height=1, width=18, bg='#DCDCDC',fg='green', font=('',26), bd=-2)
...
load_button=Button(frame3, text = 'Load Data and Generate Results', font=('',18), fg='green', bg='white', borderwidth=5, command=load_and_generate_results)
...
know_more = Button(frame3, text = 'Know More', font=('',18), bd=-2, bg='white', borderwidth=5, fg = 'black', command = know_more_function)
know_more.place(x=800,y=500)
changeOnHover(know_more, 'skyblue', 'yellow')

latest_trends = Button(frame3, text = 'Latest Trends', font=('',18), bd=-2, bg='white', borderwidth=5, fg = 'black', command = latest_trends_function)
